...
public class Alphabeth {
    public static List<AlphabethItem> getAlphabeth() {
        List<AlphabethItem> alphabeth = new ArrayList<>();
        ...
        alphabeth.add(new AlphabethItem("G",
        ...
        alphabeth.add(new AlphabethItem("H",
        ...
        alphabeth.add(new AlphabethItem("I",
        ...
        alphabeth.add(new AlphabethItem("J",
        ...
        alphabeth.add(new AlphabethItem("K",
        ...
        alphabeth.add(new AlphabethItem("L",
        ...
        alphabeth.add(new AlphabethItem("Ł",
        ...
        alphabeth.add(new AlphabethItem("M",
        ...
        alphabeth.add(new AlphabethItem("R",
        ...
        alphabeth.add(new AlphabethItem("S",
        ...
        alphabeth.add(new AlphabethItem("Ś",
